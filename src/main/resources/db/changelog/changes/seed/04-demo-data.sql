...
INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (2, 2, 3, 3, 2, 1, 2, DATE_SUB(CURDATE(), INTERVAL 3 DAY), '10:00:00', '10:45:00', 'COMPLETED', 'SYSTEM', NOW(), 'SYSTEM', NOW());

INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (3, 3, 4, 2, 3, 2, 3, DATE_SUB(CURDATE(), INTERVAL 1 DAY), '14:00:00', '14:40:00', 'CANCELLED', 'SYSTEM', NOW(), 'SYSTEM', NOW());

INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (4, 1, 2, 4, 1, 1, 4, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '09:00:00', '10:00:00', 'CONFIRMED', 'SYSTEM', NOW(), 'SYSTEM', NOW());

INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (5, 4, 5, 1, 2, 1, 1, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '11:00:00', '12:00:00', 'PENDING', 'SYSTEM', NOW(), 'SYSTEM', NOW());

INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (6, 5, 6, 2, 3, 2, 3, DATE_ADD(CURDATE(), INTERVAL 2 DAY), '08:30:00', '09:10:00', 'PENDING', 'SYSTEM', NOW(), 'SYSTEM', NOW());

INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (7, 2, 3, 3, 4, 2, 2, DATE_ADD(CURDATE(), INTERVAL 2 DAY), '13:00:00', '13:45:00', 'CONFIRMED', 'SYSTEM', NOW(), 'SYSTEM', NOW());

INSERT INTO appointments (id, customer_id, vehicle_id, technician_id, service_bay_id, dealership_id, service_type_id, appointment_date, start_time, end_time, status, created_by, created_date, last_modified_by, last_modified_date)
VALUES (8, 3, 4, 4, 1, 1, 1, DATE_ADD(CURDATE(), INTERVAL 3 DAY), '15:00:00', '16:00:00', 'PENDING', 'SYSTEM', NOW(), 'SYSTEM', NOW());
